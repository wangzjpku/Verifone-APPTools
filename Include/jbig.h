...
int jbg_uncompress(const char *fnin, const char *fnout);
int jbg_compress(const char *fnin, const char *fnout);
 ...
 */
typedef void (*byte_out_func)(int, int);
...
struct jbg_arenc_state {
  ...
  void (*byte_out)(int, int);  /* function that receives all PSCD bytes */
